...
class FormSubmissionViewComponent {
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "18.2.13", type: FormSubmissionViewComponent, selector: "form-submission-view", ngImport: i0, template: "<formio [form]=\"service.form\" [submission]=\"service.submission\" [options]=\"{readOnly: true}\"></formio>", styles: [""], dependencies: [{ kind: "component", type: i4.FormioComponent, selector: "formio", inputs: ["src", "form", "submission", "url", "options"], outputs: ["ready", "submit", "error", "change"] }] });
}

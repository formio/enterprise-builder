...
class EnterpriseBuilderAlerts extends AlertService {
    ...
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderAlerts, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderAlerts, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
class EnterpriseBuilderService extends AppService {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderService, deps: [{ token: i1.FormioAppConfig }, { token: EnterpriseBuilderAlerts }, { token: i2.Router }], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderService, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormsService, decorators: [{
            type: Injectable,
            args: [{
                    providedIn: 'root'
                }]
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormViewComponent, decorators: [{
            type: Component,
            args: [{ selector: 'form-view', standalone: false, template: "<div class=\"bg-body rounded shadow-sm p-2\">\n    <formio [url]=\"service.formUrl()\" [form]=\"service.form\" (submit)=\"onSubmit($event)\" (error)=\"onFormError($event)\"></formio>\n</div>" }]
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormsComponent, decorators: [{
            type: Component,
            args: [{ selector: 'enterprise-builder-forms', standalone: false, template: "<div class=\"d-flex justify-content-between align-items-center mb-3\">\n    <h5 class=\"my-2 d-flex gap-2 align-items-center\" style=\"font-size: 16px;\">\n        <i class=\"bi bi-list-check fs-5\"></i>\n        Forms\n    </h5>\n    <a routerLink=\"build\" class=\"btn btn-primary\">Create Form</a>\n</div>\n<div class=\"bg-body p-2 mb-3\">\n    <formio [form]=\"searchForm\" [submission]=\"search\" (ready)=\"enableSearch($event)\"></formio>\n</div>\n<div class=\"form-list-header list-group-flush d-flex flex-row justify-content-between align-items-center mb-2\">\n    <div class=\"col-8 ps-3 fw-3 text-muted\">Title</div>\n    <div class=\"col-2 ps-3 fw-3 text-muted\">Actions</div>\n    <div class=\"col-2 ps-3 fw-3 text-muted\">Tags</div>\n</div>\n<hr />\n<loader *ngIf=\"service.formsLoading\"></loader>\n<ul *ngIf=\"!service.formsLoading\" class=\"list-group list-group-flush list-group-light\">\n    <a class=\"list-group-item list-group-item-action d-flex flex-row  align-items-center py-4 mb-2 rounded shadow-sm\"\n        *ngFor=\"let form of (service.forms | async)\">\n        <!-- <i class=\"bi bi-file-medical fs-4 text-muted\"></i> -->\n        <div class=\"col-8 ms-3 mr-auto d-flex flex-row gap-4 justify-content-start align-items-center cursor-pointer\"\n            routerLink=\"{{ form._id }}/view\">\n            <div class=\"ms-3 me-auto\">\n                <div class=\"fs-4 fw-3 text-muted\">{{ form.title }}</div>\n                <div class=\"fs-6 fw-lighter text-muted\">created {{ form.created | date: 'short' }}</div>\n                <div class=\"fs-6 fw-lighter text-muted\">modified {{ form.modified | date: 'short' }}</div>\n            </div>\n        </div>\n        <div class=\"col-2 form-actions d-flex flex-row  align-items-start gap-2 text-center ml-auto\">\n            <a routerLink=\"{{ form._id }}/edit\" class=\"btn btn-outline-secondary btn-icon btn-xs rounded-circle\">\n                <i class=\"bi bi-pencil fs-xs\"></i>\n            </a>\n            <a routerLink=\"{{ form._id }}/submission\"\n                class=\"btn btn-outline-secondary btn-icon btn-xs rounded-circle\">\n                <i class=\"bi bi-table fs-xs\"></i>\n            </a>\n        </div>\n        <div class=\"col-2 form-tags d-flex flex-row align-items-center\">\n            <span class=\"badge text-bg-secondary me-1\" *ngFor=\"let tag of form.tags\">{{tag}}</span>\n        </div>\n    </a>\n</ul>\n<div *ngIf=\"!service.formsLoading\" class=\"d-flex justify-content-center\">\n    <nav aria-label=\"Forms Navigation\">\n        <ul class=\"pagination\" *ngIf=\"!service.formsLoading\">\n            <li class=\"page-item\"><button class=\"page-link\" (click)=\"service.prevPage()\"><i class=\"bi bi-chevron-left\"></i></button></li>\n            <li class=\"page-item\" *ngFor=\"let i of pageNumbers;\">\n                <button class=\"page-link\" [attr.aria-current]=\"i===service.page\" [ngClass]=\"{active: (i === service.page)}\" (click)=\"service.goto(i)\">{{ i }}</button>\n            </li>\n            <li class=\"page-item\"><button class=\"page-link\" (click)=\"service.nextPage()\"><i class=\"bi bi-chevron-right\"></i></button></li>\n        </ul>\n    </nav>\n</div>\n" }]
...
class FormDeleteComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormDeleteComponent, deps: [{ token: FormsService }, { token: i2.Router }, { token: i2.ActivatedRoute }, { token: EnterpriseBuilderAlerts }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.0.5", type: FormDeleteComponent, isStandalone: false, selector: "form-delete", ngImport: i0, template: "<div class=\"p-3\">\n    <h3>Are you sure you wish to delete {{service.form?.title}} form?</h3>\n    <div class=\"btn-toolbar\">\n        <button type=\"button\" (click)=\"onDelete()\" class=\"btn btn-danger me-2\">Yes</button>\n        <button type=\"button\" (click)=\"onCancel()\" class=\"btn btn-default\">No</button>\n    </div>\n</div>" });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormDeleteComponent, decorators: [{
            type: Component,
            args: [{ selector: 'form-delete', standalone: false, template: "<div class=\"p-3\">\n    <h3>Are you sure you wish to delete {{service.form?.title}} form?</h3>\n    <div class=\"btn-toolbar\">\n        <button type=\"button\" (click)=\"onDelete()\" class=\"btn btn-danger me-2\">Yes</button>\n        <button type=\"button\" (click)=\"onCancel()\" class=\"btn btn-default\">No</button>\n    </div>\n</div>" }]
        }], ctorParameters: () => [{ type: FormsService }, { type: i2.Router }, { type: i2.ActivatedRoute }, { type: EnterpriseBuilderAlerts }] });

class FormCompleteComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormCompleteComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.0.5", type: FormCompleteComponent, isStandalone: false, selector: "form-complete", ngImport: i0, template: "<div class=\"alert alert-success\">Submission Complete!</div>" });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormCompleteComponent, decorators: [{
            type: Component,
            args: [{ selector: 'form-complete', standalone: false, template: "<div class=\"alert alert-success\">Submission Complete!</div>" }]
        }] });

class FormErrorComponent {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormErrorComponent, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.0.5", type: FormErrorComponent, isStandalone: false, selector: "form-error", ngImport: i0, template: "<div class=\"alert alert-danger\">Unable to submit form. Please contact the administrator.</div>" });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormErrorComponent, decorators: [{
            type: Component,
            args: [{ selector: 'form-error', standalone: false, template: "<div class=\"alert alert-danger\">Unable to submit form. Please contact the administrator.</div>" }]
        }] });
...
class FormSubmissionDeleteComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormSubmissionDeleteComponent, deps: [{ token: FormsService }, { token: i2.Router }, { token: i2.ActivatedRoute }, { token: EnterpriseBuilderAlerts }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.0.5", type: FormSubmissionDeleteComponent, isStandalone: false, selector: "form-submission-delete", ngImport: i0, template: "<h3>Are you sure you wish to delete this record?</h3>\n<div class=\"btn-toolbar\">\n  <button type=\"button\" (click)=\"cancel()\" class=\"btn btn-primary me-3 px-3 py-2\">No</button>\n  <button type=\"button\" (click)=\"deleteSubmission()\" class=\"btn btn-light px-3 py-2\" style=\"margin-right: 10px;\">Yes, delete this submission</button>\n</div>", styles: [""] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormSubmissionDeleteComponent, decorators: [{
            type: Component,
            args: [{ selector: 'form-submission-delete', standalone: false, template: "<h3>Are you sure you wish to delete this record?</h3>\n<div class=\"btn-toolbar\">\n  <button type=\"button\" (click)=\"cancel()\" class=\"btn btn-primary me-3 px-3 py-2\">No</button>\n  <button type=\"button\" (click)=\"deleteSubmission()\" class=\"btn btn-light px-3 py-2\" style=\"margin-right: 10px;\">Yes, delete this submission</button>\n</div>" }]
        }], ctorParameters: () => [{ type: FormsService }, { type: i2.Router }, { type: i2.ActivatedRoute }, { type: EnterpriseBuilderAlerts }] });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormSubmissionEditComponent, decorators: [{
            type: Component,
            args: [{ selector: 'form-submission-edit', standalone: false, template: "<formio [form]=\"service.form\" [submission]=\"service.submission\" (submit)=\"saveSubmission($event)\"></formio>" }]
        }], ctorParameters: () => [{ type: FormsService }, { type: i2.Router }, { type: i2.ActivatedRoute }, { type: EnterpriseBuilderAlerts }] });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormSubmissionsComponent, decorators: [{
            type: Component,
            args: [{ selector: 'form-submissions', standalone: false, template: "<div class=\"p-3\">\n    <formio [form]=\"submissionForm\" (ready)=\"onFormio($event)\"></formio>\n</div>\n" }]
        }], ctorParameters: () => [{ type: FormsService }, { type: i2.Router }, { type: i2.ActivatedRoute }] });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormSubmissionViewComponent, decorators: [{
            type: Component,
            args: [{ selector: 'form-submission-view', standalone: false, template: "<formio [form]=\"service.form\" [submission]=\"service.submission\" [options]=\"{readOnly: true}\"></formio>" }]
        }], ctorParameters: () => [{ type: FormsService }] });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormSettingsComponent, decorators: [{
            type: Component,
            args: [{ selector: 'form-settings', standalone: false, template: "<div class=\"row\">\n    <div class=\"col col-8\">\n        <h4>Form Settings</h4>\n        <div class=\"bg-body rounded shadow-sm p-2\">\n            <formio [form]=\"settingsForm\" [submission]=\"settings\"></formio>\n        </div>\n    </div>\n    <div class=\"col col-4\">\n        <h4>Danger Zone</h4>\n        <div class=\"bg-body border border-danger rounded shadow-sm p-2\">\n            <a class=\"btn btn-danger\" routerLink=\"../delete\">Delete Form</a>\n        </div>\n    </div>\n</div>\n<div class=\"d-flex my-3\">\n    <a type=\"button\" class=\"btn btn-success align-self-end\" (click)=\"saveForm()\">Save Form</a>\n</div>" }]
        }] });
...
class FormChangesComponent extends FormEditComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormChangesComponent, deps: [{ token: FormsService }, { token: i2.Router }, { token: i2.ActivatedRoute }, { token: EnterpriseBuilderAlerts }], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "19.0.5", type: FormChangesComponent, isStandalone: false, selector: "form-changes", usesInheritance: true, ngImport: i0, template: "<div class=\"p-3\">\n    <h3>You have made some changes to this form. Would you like to save your changes?</h3>\n    <div class=\"btn-toolbar\">\n        <button type=\"button\" (click)=\"saveForm()\" class=\"btn btn-primary me-2\">Yes, save my changes</button>\n        <button type=\"button\" (click)=\"cancel()\" class=\"btn btn-default\">No</button>\n    </div>\n</div>" });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormChangesComponent, decorators: [{
            type: Component,
            args: [{ selector: 'form-changes', standalone: false, template: "<div class=\"p-3\">\n    <h3>You have made some changes to this form. Would you like to save your changes?</h3>\n    <div class=\"btn-toolbar\">\n        <button type=\"button\" (click)=\"saveForm()\" class=\"btn btn-primary me-2\">Yes, save my changes</button>\n        <button type=\"button\" (click)=\"cancel()\" class=\"btn btn-default\">No</button>\n    </div>\n</div>" }]
        }], ctorParameters: () => [{ type: FormsService }, { type: i2.Router }, { type: i2.ActivatedRoute }, { type: EnterpriseBuilderAlerts }] });
...
class EnterpriseBuilderLoaderModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderLoaderModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderLoaderModule, declarations: [EnterpriseBuilderLoaderComponent], imports: [CommonModule], exports: [EnterpriseBuilderLoaderComponent] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderLoaderModule, imports: [CommonModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderLoaderModule, decorators: [{
            type: NgModule,
            args: [{
                    declarations: [
...
class FormsModule {
    ...
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "19.0.5", ngImport: i0, type: FormsModule, declarations: [FormsComponent,
            FormBuildComponent,
            FormViewComponent,
            FormEditComponent,
            FormComponent,
            ...
            RouterModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: FormsModule, providers: [
            FormsService,
...
class EnterpriseBuilderModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderModule });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderModule, providers: [
            EnterpriseBuilderService,
            EnterpriseBuilderAlerts
        ] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderModule, decorators: [{
            type: NgModule,
            args: [{
                    providers: [
                        EnterpriseBuilderService,
...
class EnterpriseBuilderAppConfig extends FormioAppConfig {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderAppConfig, deps: [{ token: ENTERPRISE_BUILDER_CONFIG }], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderAppConfig });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.5", ngImport: i0, type: EnterpriseBuilderAppConfig, decorators: [{
            type: Injectable
